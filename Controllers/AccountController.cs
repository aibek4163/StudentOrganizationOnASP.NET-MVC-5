...
namespace StudentOrganization.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //public async Task<ActionResult> checkEmail(RegisterViewModel model)
        //{
        ...
        //    else
        //    {
        //        return Json($"This email {model.Email} already exist");
        //    }
        //}
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser {
                    ...
                    group = model.group_2,
                    picture_url = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDqY8flpg0BMqJ0qy1ISjuLX948FJooqnWdA&usqp=CAU"
                };
                //var gr = await context.Groups.FindAsync(model.Group);
                //user.group = gr;
